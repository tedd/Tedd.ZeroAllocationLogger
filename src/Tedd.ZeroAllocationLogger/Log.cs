...
public static unsafe class Log
{
    ...
    private static byte* _basePtr = null; // The cached base pointer.

    private static long _capacity;
    private static long _position;
    private static int _unflushedBytes;
    private static long _remapAt;

    private static readonly System.Threading.Lock _lock = new(); // Use the new, dedicated Lock object from .NET 9 for optimized locking.
    private static readonly ReadOnlyMemory<byte> NewLineBytes = Encoding.UTF8.GetBytes(Environment.NewLine).AsMemory();
    private static readonly ReadOnlyMemory<byte> TrueBytes = "True"u8.ToArray().AsMemory();
    private static readonly ReadOnlyMemory<byte> FalseBytes = "False"u8.ToArray().AsMemory();
    private static readonly ReadOnlyMemory<byte> SPACE = " "u8.ToArray().AsMemory();
...
#pragma warning restore CA1815
    ...
    public static ScopedLockToken AcquireScopedLock()
    {
        _lock.Enter();
        return new ScopedLockToken();
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteSpace() => InternalWrite(SPACE.Span);

    private static void InternalWrite(ReadOnlySpan<byte> data)
    {
...
#pragma warning restore CA2201
    ...
    private static void OpenMemoryMapped(string filePath, long maxSizeInBytes)
    {
    ...
    private static void CloseMemoryMapped()
    {
        lock (_lock)
        {
            InternalFlush();
    ...
    private static void CheckFlushThreshold()
    {
    ...
    private static void CheckRemap()
    {
        if (_position < _remapAt)
            return;
    ...
    [Experimental(Constants.ExperimentalAllocString)]
    public static void Write(ReadOnlySpan<char> data)
    {
        if (data.IsEmpty) return;
    ...
    public static void Write(sbyte data)
    {
        Span<byte> buffer = stackalloc byte[4]; // Max: "-128"
        if (Utf8Formatter.TryFormat(data, buffer, out int bytesWritten)) InternalWrite(buffer.Slice(0, bytesWritten));
    }

    public static void Write(short data)
    {
    ...
    public static void Write(ulong data)
    {
    ...
    public static void Write(decimal data)
    {
    ...
    public static void Write(bool data) => InternalWrite(data ? TrueBytes.Span : FalseBytes.Span);
    [Experimental(Constants.ExperimentalAllocString)]
    ...
    public static void Write(EndPoint endPoint)
    {
    ...
    /// </summary>
    public static void WriteDate(DateTime dt)
    {
    ...
    /// </summary>
    public static void WriteTime(DateTime dt)
    {
    ...
    /// </summary>
    public static void WriteTimeMs(DateTime dt)
    {
    ...
    /// </summary>
    public static void WriteDateTimeStamp(DateTime date)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteLine() => InternalWrite(NewLineBytes.Span);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Experimental(Constants.ExperimentalAllocString)]
    public static void WriteLine(string data) { using (AcquireScopedLock()) { Write(data); WriteLine(); } }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteLine(byte data) { using (AcquireScopedLock()) { Write(data); WriteLine(); } }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteLine(sbyte data) { using (AcquireScopedLock()) { Write(data); WriteLine(); } }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteLine(short data) { using (AcquireScopedLock()) { Write(data); WriteLine(); } }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteLine(ushort data) { using (AcquireScopedLock()) { Write(data); WriteLine(); } }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteLine(int data) { using (AcquireScopedLock()) { Write(data); WriteLine(); } }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteLine(uint data) { using (AcquireScopedLock()) { Write(data); WriteLine(); } }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteLine(long data) { using (AcquireScopedLock()) { Write(data); WriteLine(); } }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteLine(ulong data) { using (AcquireScopedLock()) { Write(data); WriteLine(); } }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteLine(float data) { using (AcquireScopedLock()) { Write(data); WriteLine(); } }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteLine(double data) { using (AcquireScopedLock()) { Write(data); WriteLine(); } }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteLine(decimal data) { using (AcquireScopedLock()) { Write(data); WriteLine(); } }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteLine(bool data) { using (AcquireScopedLock()) { Write(data); WriteLine(); } }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Experimental(Constants.ExperimentalAllocString)]
    public static void WriteLine(char data) { using (AcquireScopedLock()) { Write(data); WriteLine(); } }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteLine(ReadOnlySpan<byte> data) { using (AcquireScopedLock()) { Write(data); WriteLine(); } }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void WriteLine(EndPoint data) { using (AcquireScopedLock()) { Write(data); WriteLine(); } }
    ...
    /// </summary>
    [Experimental(Constants.ExperimentalAllocString)]
    public static string ReadCurrentContent()
    {
        lock (_lock)
        {
